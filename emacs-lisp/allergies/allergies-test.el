...
(declare-function remove-excess-powers-of-base "allergies.el" (total max base))
(declare-function allergen-list "allergies.el" (score))
(declare-function allergic-to-p "allergies.el" (score allergen))

(ert-deftest remove-excess-from-0 ()
             (should (equal 0 (remove-excess-powers-of-base 0 128 2))))

(ert-deftest remove-excess-from-1 ()
             (should (equal 1 (remove-excess-powers-of-base 1 128 2))))

(ert-deftest remove-excess-from-2 ()
             (should (equal 2 (remove-excess-powers-of-base 2 128 2))))

(ert-deftest remove-excess-from-7 ()
             (should (equal 7 (remove-excess-powers-of-base 7 128 2))))

(ert-deftest remove-excess-from-255 ()
             (should (equal 255 (remove-excess-powers-of-base 255 128 2))))

(ert-deftest remove-excess-from-509 ()
             (should (equal 253 (remove-excess-powers-of-base 509 128 2))))
